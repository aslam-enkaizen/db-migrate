...
import com.exrade.providers.password.DefaultUsernamePasswordAuthUser;

public class ExLoginUsernamePasswordAuthUser extends
	 ...
	 * @param email
	 */
	public ExLoginUsernamePasswordAuthUser(final String email) {
		this(null, email);
	}

	public ExLoginUsernamePasswordAuthUser(final String clearPassword,
			final String email) {
